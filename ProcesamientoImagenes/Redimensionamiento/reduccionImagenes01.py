...
def open_image():
    ...
    if path:
        ...
        original_photo = ImageTk.PhotoImage(image.resize((400, 400)))

        # Actualizar el tamaño del lienzo de la imagen original
        original_canvas.configure(width=400, height=400)
...
def apply_filter_and_show():
    ...
    filtered_photo = ImageTk.PhotoImage(new_image.resize((400, 400)))

    # Actualizar el tamaño del lienzo de la imagen filtrada
    filtered_canvas.configure(width=400, height=400)
