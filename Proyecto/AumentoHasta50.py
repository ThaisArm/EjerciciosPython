...
for person_dir in os.listdir(root_dir):
    ...
    # Verificar si la persona ya tiene al menos 50 imágenes en el dataset
    if len(original_images) >= 50:
        selected_images = original_images[:50]  # Seleccionar las primeras 50 imágenes
    else:
    ...
    for image_file in selected_images:
        ...
        # Verificar cuántas imágenes adicionales se deben generar para llegar a 50
        remaining_images = 50 - len(selected_images)
